const list_cards = [
    ...
    {
        tipo: "app",
        imagen: "back/androidstudio3.png",
    ...
    {
        titulo: "Singleton - Creational",
        texto: "Ensures that a class has only one instance. A real-world example is handling a database connection in an API: you don't want to open 1000 simultaneous connections, but rather reuse a single connection object throughout the application to save resources and maintain consistency.",
        enlace: "#",
        imagen: "back/sigleton.png",
        tipo: "patrones"
    },
    {
        titulo: "Factory Method - Creational",
        texto: "Defines an interface for creating objects but lets subclasses decide which class to instantiate. In a logistics system, you might have a 'Transport' class. The Factory will decide whether to instantiate 'Truck' or 'Ship' depending on the delivery type, without the client knowing the creation details.",
        enlace: "#",
        imagen: "back/factory.png",
        tipo: "patrones"
    },
    {
        titulo: "Observer - Behavioral",
        texto: "Allows an object to notify others of changes in its state. It is the foundation of subscription or newsletter systems: when the 'Subject' (a blog) publishes content, all 'Observers' (subscribers) automatically receive the update without needing to ask manually.",
        enlace: "#",
        imagen: "back/observer.png",
        tipo: "patrones"
    },
    {
        titulo: "Strategy - Behavioral",
        texto: "Allows swapping algorithms at runtime. Imagine a payment processor in an e-commerce platform: the system uses the Strategy pattern to dynamically switch between 'Credit Card', 'PayPal', or 'Crypto' depending on the user's choice, keeping the checkout code clean and modular.",
        enlace: "#",
        imagen: "back/strategy.png",
        tipo: "patrones"
    },
    {
        titulo: "Adapter - Structural",
        texto: "Allows objects with incompatible interfaces to work together. It is very common when integrating third-party external APIs: you create an 'Adapter' that translates the strange data sent by the external provider into the internal format that your application already understands and processes.",
        enlace: "#",
        imagen: "back/adapter.png",
        tipo: "patrones"
    },
    {
        titulo: "Model-View-Controller (MVC)",
        texto: "The gold standard for decoupling business logic from the interface. After years of working with frameworks like Laravel and .NET, MVC remains the most solid foundation for organizing data flow. Although architectures like Clean Architecture expand on it, understanding MVC is an obligatory step for any robust backend developer.",
        enlace: "#",
        imagen: "back/mvc.png",
        tipo: "patrones"
    },
    {
        ...
        texto: "Clean Architecture is not just a folder structure; it is a design philosophy aimed at decoupling business logic from technical details (DB, Frameworks, UI). It is based on the Dependency Rule: code dependencies can only point inwards, toward the business entities.",
        enlace: "#",
        imagen: "back/clean.png",
        tipo: "patrones"
    },
